# vortex-storm
An [Apache Storm](https://storm.apache.org/) [Spout](https://storm.apache.org/documentation/Concepts.html) and [Bolt](https://storm.apache.org/documentation/Concepts.html) for consuming and producing [Vortex](http://www.prismtech.com/vortex) data

## Building for [Vortex Cafe](http://www.prismtech.com/vortex/vortex-cafe)
```bash
mvn install -P cafe-build
```

## Building for [Vortex OpenSplice](http://www.prismtech.com/vortex/vortex-opensplice)
